    ...
    def Prefabs(self):
        ...
        if len(cellmates) != 0:
            for i in cellmates:
                ...
                elif i.agent == "fullStack" and self.BOX == True:
                    self.BOX = True
                    self.agent = "robotCaja"
                    i.agent = "fullStack"
   ...
   #Modelación del comportamiento de todos los agentes.
    ...
    def __init__(self, width, height, agents, boxes, steps):
        ...
        self.dataCollectorMovements = DataCollector(
            model_reporters={"Total Movements":BoxCollector.calculateMovements},
            agent_reporters={}
        )
        self.dataCollectorBoxes = DataCollector(
            model_reporters={"Boxes Left":BoxCollector.calculateBoxes},
            agent_reporters={}
        )
    ...
    def step(self):
        ...
        print("Pasos restantes: ", self.pasosTotales)
        print(" ")